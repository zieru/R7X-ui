    ...
    >
      <div class="setting-drawer-index-content">
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Style Settings</h3>
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Layout</h3>
            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  <template slot="title">
                    This setting is only valid for [Top Bar Navigation]
                  </template>
              ...
              <a-list-item>
                ...
                <a-list-item-meta>
                  <a-tooltip slot="title" placement="left">
                    <template slot="title">Hide Header When Scroll</template>
                    <div :style="{ opacity: !fixedHeader ? '0.5' : '1' }">Hide when Header When Sliding</div>
                  </a-tooltip>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item >
                ...
                <a-list-item-meta>
                  <div slot="title" :style="{ textDecoration: layoutMode === 'topmenu' ? 'line-through' : 'unset' }">Fixed Sidebar Menu</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
